...
async def register_user(
    ...
    try:
        ...
        activation_link = f"{base_url}/accounts/activate/{activation_token.token}"
...
async def activate_account(
    ...
    login_page_url = "http://127.0.0.1/accounts/login/"

    background_tasks.add_task(
        email_sender.send_activation_complete_email,
        str(user.email),
        login_link = login_page_url,
    )
...
async def request_password_reset_token(
    ...
    reset_link = f"{base_url}/reset-password/{reset_token.token}"
